        ...
        <div className="max-w-7xl mx-auto w-[95%] lg:w-[97%] mb-6 md:mb-8">
          <div className="flex justify-end">
            <button
              ...
              className="flex items-center px-6 py-3 text-[13px] sm:text-sm md:text-base font-medium rounded-lg rounded-tr-3xl rounded-bl-3xl cursor-pointer bg-linear-to-r from-[#fc4422] to-[#ff9266] text-white transition-all duration-300 hover:scale-101 active:scale-99"
            >
