      ...
      >
        ...
        <form id="login" onSubmit={handleSubmit} className="space-y-6">
          <div className="relative">
            ...
            />
            <label
              className="absolute left-0 -top-3.5 text-sm text-gray-100 transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-300 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-gray-100 peer-focus:text-sm"
              htmlFor="email"
            >
              Email
            </label>
          ...
          <div className="flex items-center justify-between">
            ...
            <a className="text-sm text-gray-300 hover:underline" href="#">
              Forgot your password?
            </a>
          </div>
          <button
            className="w-full py-2 px-4 bg-white text-primary cursor-pointer hover:bg-gray-100 rounded-md shadow-lg font-semibold transition duration-200 active:bg-gray-200"
            type="submit"
          >
            Sign In
          </button>
        </form>
        <div className="flex items-center justify-center space-x-4 my-4 text-gray-200">
          <div className="w-1/3 border-b border-grtext-gray-300"></div>
          <span>OR</span>
          <div className="w-1/3 border-b border-grtext-gray-300"></div>
        </div>
        <div>
          <button
            ...
            className="flex items-center justify-center cursor-pointer py-2 px-20 bg-white hover:bg-gray-100 text-black w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md rounded-lg active:bg-gray-200"
          >
            <svg
              viewBox="0 0 24 24"
              height="20"
