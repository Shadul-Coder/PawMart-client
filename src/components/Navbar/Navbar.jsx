...
import logo from "../../assets/Tittle Logo.png";
...
const Navbar = () => {
  ...
  useEffect(() => {
    if (theme === "dark") {
      themeButton.current.checked = true;
    }
        ...
        <label className="inline-flex items-center relative">
          ...
          <div
            className="relative w-[110px] h-[50px] bg-white peer-checked:bg-zinc-500 rounded-full 
              ...
              peer-checked:after:bg-zinc-900 after:rounded-full after:top-[5px] after:left-[5px] 
              active:after:w-[50px] peer-checked:after:left-[105px] 
              peer-checked:after:-translate-x-full shadow-sm duration-300 
              after:duration-300 after:shadow-md"
          >
            <style>
              {`
                label input:not(:checked) + div::after {
                  background: linear-gradient(to right, #f04336, #ff9266);
                }
              `}
            </style>
          </div>
