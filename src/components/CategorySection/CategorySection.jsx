      ...
      <div className="max-w-7xl mx-auto w-[95%] pt-9 sm:pt-13 lg:w-[97%]">
        <div className="text-center mb-8 md:mb-12 lg:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
            Everything for Your <span className="text-[#fc4422]">Pets</span>
          </h2>
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-6 z-10">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 bg-white/20 backdrop-blur-sm rounded-3xl flex items-center justify-center mb-4 sm:mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
